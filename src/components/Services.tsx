    ...
    <section id="servicios" className="py-24 bg-lumux-bg relative overflow-x-clip">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 max-w-4xl">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-medium font-heading text-white mb-3 leading-tight">
            ¿Qué querés lograr <span className="text-lumux-red">con tu auto?</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 mb-24 overflow-visible">
          {GOALS.map((goal, i) => {
            ...
            return (
              <motion.a
                ...
                className="group relative p-5 sm:p-6 rounded-2xl bg-[#161616] hover:bg-[#1f1f1f] border border-[#262626] hover:border-gray-600 transition-colors duration-200 flex items-center justify-between gap-4 shadow-md overflow-hidden cursor-pointer"
              >
                ...
                <div className="flex-1 min-w-0 pr-2">
                  <h3 className="text-sm sm:text-base font-semibold uppercase tracking-wide text-white group-hover:text-gray-200 transition-colors">
                    {goal.title}
                  </h3>
                ...
                {/* Arrow Icon */}
                <div className="w-10 h-10 rounded-full border border-lumux-border flex items-center justify-center text-gray-400 group-hover:bg-lumux-red group-hover:text-white group-hover:border-lumux-red transition-all flex-shrink-0 shadow-sm">
